 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Oscar: Autonomous Tank - Linear2", group = "Oscar")

public class LinearAutoOp2 extends LinearOpMode {
    DcMotor rightFront;
 ...
 boolean isReady= false;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        shooter.setMode(DcMotor.RunMode.RUN_USING_ENCODER);// sets the direction
